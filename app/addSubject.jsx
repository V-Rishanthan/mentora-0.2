            ...
            {thumbnail ? (
              ...
              <View className="border-2 border-dashed border-grayPro-300 rounded-xl p-6 items-center justify-center bg-grayPro-50 mb-3">
                ...
                <View className="flex-row space-x-3 w-full">
                  ...
                  {/* <TouchableOpacity
                    onPress={takePhoto}
                    className="flex-1 bg-grayPro-200 py-3 rounded-lg items-center flex-row justify-center"
                  >
                    <Camera size={18} color="#444546" className="mr-2" />
                    <Text className="text-grayPro-800 font-outfit-semibold">Camera</Text>
                  </TouchableOpacity> */}
                </View>
